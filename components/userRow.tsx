...
export default function UserRow(UserData: UserTypes) {
  ...
  return (
    <tr className="odd:bg-rose-pale even:bg-white-rose dark:odd:bg-green-lowest-2 dark:even:bg-green-lowest">
      <td className="pl-4 px-4 pt-4 flex flex-row">
      ...
      <td className="flex gap-2">
        <button className="cursor py-5 text-blue-01 hover:text-blue-02  duration-500">
          <BiEdit onClick={onUpdate} size={25}></BiEdit>
        </button>
        <button type="button" data-modal-toggle='popup-modal' className="cursor py-5 text-red-500 hover:text-red-600  duration-500 ">
